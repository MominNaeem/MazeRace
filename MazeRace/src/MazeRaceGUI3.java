...
public class MazeRaceGUI3 extends JFrame implements KeyListener, ActionListener {
	...
	private void checkScore() {
		...
		if (score < Integer.parseInt((highScore.split(":")[1]))) {
			...
			File scoreFile = new File("./src/highscoreonetwo.dat");
			if (!scoreFile.exists()) {
				try {
	...
	public String getHighScore() {
		...
		try {
			...
			readFile = new FileReader("./src/highscoretwo.dat");
	...
	private void frameSetup() {
		...
		title = new JLabel(new ImageIcon("./images/Maze3Button.png"));
